...
### P0-6: Fix hostname contradiction
...
### P0-7: Register real canarytokens
...
### P1-7: Populate `threat_score`, `tags`, `is_tor` columns
...
### P1-8: Fix sidebar nav links that return JSON instead of HTML
...
### P1-9: `bot_score` used in sentinel alerting
- **File:** `deploy/module-5-log-shipper/src/sentinel.py`
...
### P2-1: `/notifications` page with SSH node hints
...
### P2-2: `/settings/profile` page with SSH key copy telemetry
...
### P2-3: `/settings/security` page — 2FA settings capture attacker email
...
### P2-5: DevTools detection in `metrics.js`
...
### P2-6: Fix `X-Debug-Mode` header scope
...
### P2-7: Add `/.git/config` and `/.git/HEAD` routes with plain-text responses
- **File:** `main.py`
...
### P2-8: Dataset download button telemetry
...
### P2-9: API key reveal button + stored key replay detection
...
### P2-10: Kill chain stage state machine
...
### P2-11: `settings/workspace` as proper HTML page
...
### P2-12: Fix `api_docs.html` consistency issues
- **File:** `frontend-latest/api_docs.html`
- **Gaps:**
...
### P2-13: Footer on all authenticated pages
...
### P2-14: `admin.html` username from session, not hardcoded
...
### P3-1: IP reputation enrichment pipeline
...
### P3-2: Prompt injection detection
- **File:** `main.py`
...
### P3-3: SMB sensor via OpenCanary
...
### P3-4: SMTP minimal listener (replace broken OpenCanary SMTP)
...
### P3-5: Jupyter stub externally exposed
...
### P3-7: Fake team activity feed in dashboard
- **File:** `frontend-latest/dashboard.html`
...
### P3-8: Support ticket widget — free-text attacker capture
...
### P3-9: Double URL-encoding bypass fix for `_detect_web_attack()`
- **File:** `main.py`
